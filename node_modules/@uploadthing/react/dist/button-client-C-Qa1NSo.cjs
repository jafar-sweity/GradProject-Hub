 ...
 */ function UploadButton(props) {
    ...
    const { startUpload, isUploading, routeConfig } = __useUploadThingInternal(shared.resolveMaybeUrlArg($props.url), $props.endpoint, {
...
exports.progressWidths = progressWidths;
